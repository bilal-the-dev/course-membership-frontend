...
import { Navbar, Sidebar, ChapterCard } from "../../index.js";

const chapters = [
  { chapter: "Video 01", duration: "60 hrs" },
  { chapter: "Video  02", duration: "60 hrs" },
  { chapter: "Video 03", duration: "60 hrs" },
  { chapter: "Video 04", duration: "60 hrs", isLocked: true },
  { chapter: "Video 05", duration: "60 hrs", isLocked: true },
];
...
<div className='block lg:hidden lg:w-12 w-0.5 mt-4 lg:mt-0 xl:h-0.5 h-12 lg:mx-auto bg-primary_gold' />
      ...
      4xl:max-w-[1280px] 5xl:max-w-[1400px] `}>
            ...
            <div className="flex flex-col justify-center pt-12 items-center flex-wrap -mx-4">
              {chapters.map((item, index) => {
                const rowNumber = Math.floor(index / 3);
                const isLastRow =
                  Math.ceil(chapters.length / 3) === rowNumber + 1;
                const alignment =
                ...
                return (
                  <React.Fragment key={index}>
                    <div
                      key={index}
                      className={`w-full   justify-center items-center  lg:w-1/2  px-4  mb-4 `}
                    >
                      <div
                      ...
                      >
                        ...
                        {index !== chapters.length - 1 && (
                          <div className=" text-center  w-1  -mb-8 mt-6 h-12 text-primary_gold text-lg  bg-primary_gold">
                            <div className="hidden lg:block" />
                          </div>
                        )}
                      </div>
                    </div>
                    {index !== chapters.length - 1 && !item.placeholder && (
                      <div
