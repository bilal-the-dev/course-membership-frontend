        ...
        <div className='w-full  px-8'>
          <div className="w-full flex flex-col lg:flex-row lg:p-2 h-full ">
            <div className='w-full cursor-pointer relative '>
                <img className='w-full opacity-50 object-cover ' src={image} alt="" />
                <div className='absolute inset-0 flex justify-center items-center'>
                <img className='' src={play} alt="" /></div>
                </div>
...
<div className='p-1 lg:p-4'>
    <h1 className='text-2xl lg:text-3xl xl:text-4xl font-semibold text-primary_gold '>Lorem ipsum dolor sit amet consectetur adipiscing elit <br className=' hidden lg:block' />
    sed do eiusmod tempos</h1>
</div>
<div className='flex flex-col text-secondary-gray gap-y-4'>
 <h1 className='text-white font-semibold text-lg'>Description</h1>   
<p className='leading-tight'>Lorem ipsum dolor sit amet consectetur adipiscing elit
sed do eiusmod tempor incididunt ut labore  et  <br />dolore magna aliqua</p>
<p className='leading-tight'>Lorem ipsum dolor sit amet consectetur adipiscing elit
sed do eiusmod tempor incididunt ut labore  et <br /> dolore magna aliqua</p>
<h1 className='text-white font-semibold text-lg'>Duration: <span className='text-secondary-gray  font-normal'>3hrs | 23 mins</span></h1>
<h1 className='text-white font-semibold text-lg'>Instructor: <span className='text-secondary-gray font-normal '>John alver</span></h1>
</div>
